...
public class TicketcheckActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		start.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (showId != 0) {
					...
					AlarmReceiver.setAlarm(TicketcheckActivity.this, interval, showId);
					updateStatus();
					CharSequence startedWithInterval = getResources().getText(R.string.startedwithinterval) + " " + interval + " "
							+ getResources().getText(R.string.minutes);
					Toast toast = Toast.makeText(TicketcheckActivity.this, startedWithInterval, Toast.LENGTH_SHORT);
					toast.show();
				} else {
					showError();
				}
		...
		stop.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				updateStatus();
				Toast toast = Toast.makeText(TicketcheckActivity.this, R.string.alarmstopped, Toast.LENGTH_SHORT);
				toast.show();
			}
		});
	}
	...
	private void showError() {
		Toast toast = Toast.makeText(TicketcheckActivity.this, R.string.errorshow, Toast.LENGTH_SHORT);
		toast.show();
	}
	...
	private void updateStatus() {
		...
		status.setText(getResources().getText(AlarmReceiver.isAlarmSet(this) ? R.string.started : R.string.stopped));
	}
}